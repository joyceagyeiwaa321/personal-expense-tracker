	...
	public class Admin : User
	{
		...
		public void GenerateReport()
		{
			try
			{
				...
				string path = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile),"Downloads","FinancyReport_" + DateTime.Now.ToString("yyyy-MM-dd") + ".txt");
