...
namespace FinancyApplication
{
    public partial class MainWindow : Window
    {
        ...
        private void RunTests_Click(object sender, RoutedEventArgs e)
        {
            ...
            string verificationCode = Microsoft.VisualBasic.Interaction.InputBox(
            ...
            user.ResetPassword(testEmail, "TestUser");
        ...
        private void RunMyTests_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                // These are temporary database IDs used only to test my three classes.
                // They should already exist in the database before running this test.
                int userId = 1;
                int accountId = 1;
                int categoryId = 1;
                int transId = 1;

                // My class test 1: Budget
                Test_Budget(userId, categoryId);

                // My class test 2: RecurringTransaction
        ...
        // ── MY PART: RECURRING TRANSACTION TEST ──────────────────────
